<script>
	...
	const MODELS = [
		{
			...
			desc: 'OpenAI\'s latest flagship. 500B parameters, native multimodality, superior reasoning.'
		},
		{
			id: 'o3',
			name: 'o3',
			...
			desc: 'OpenAI\'s reasoning model — superseded by GPT-5.4 but still strong at math.'
		},
		{
			id: 'claudeopus',
			name: 'Claude Opus',
			...
			desc: 'Anthropic\'s most intelligent model. Claude Opus — best in class reasoning and safety.'
		},
		{
			id: 'gemini25',
			name: 'Gemini 2.5 Pro',
		...
		},
		{
			...
			desc: 'DeepSeek V3 base model — 671B MoE, extremely cheap API pricing, open weights.'
		},
		{
			id: 'deepseekr1',
			name: 'DeepSeek R1',
		...
		},
		{
			...
			desc: 'Alibaba\'s Qwen 3 with hybrid reasoning modes. Strong open-source alternative.'
		},
		{
			id: 'mistral',
		...
		},
		{
			...
			desc: 'Meta\'s Llama 4 with native multimodality. 400B MoE beats GPT-4o on many tasks.'
		},
	];
	...
	const TICKER = '🧠 LLM RESEARCH · GPT-4o · CLAUDE 4 · GEMINI 2.5 PRO · KIMI K1.5 · GROK 3 · DEEPSEEK V3 · LLAMA 4 · QWEN 3 · ';

	const NEWS = [
		{ lab: 'OpenAI',        color: '#10a37f', text: 'o4-mini launches: Near-o3 performance at 1/10th the cost',              ago: '2h' },
		{ lab: 'Moonshot',      color: '#7c3aed', text: 'Kimi K1.5 reaches 1T parameters with 256K context window',               ago: '5h' },
		{ lab: 'Anthropic',     color: '#d97757', text: 'Claude 4 Sonnet now with extended thinking up to 64K tokens',            ago: '8h' },
		{ lab: 'Google',        color: '#4285f4', text: 'Gemini 2.5 Pro Experimental with native image generation',               ago: '12h' },
		{ lab: 'DeepSeek',      color: '#4d6bfe', text: 'DeepSeek V4 rumored — 1.5T MoE with 500K context',                       ago: '1d' },
		{ lab: 'Meta',          color: '#0064e0', text: 'Llama 4 Scout & Maverick now available via API partners',                ago: '1d' },
		{ lab: 'Alibaba',       color: '#ff6a00', text: 'Qwen 3 235B launches with hybrid reasoning modes',                       ago: '2d' },
	];
